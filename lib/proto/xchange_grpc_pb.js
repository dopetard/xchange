...
var xchange_pb = require('./xchange_pb.js');

function serialize_xchangerpc_GetInfoRequest(arg) {
  if (!(arg instanceof xchange_pb.GetInfoRequest)) {
...
function deserialize_xchangerpc_GetInfoRequest(buffer_arg) {
  return xchange_pb.GetInfoRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_xchangerpc_GetInfoResponse(arg) {
  if (!(arg instanceof xchange_pb.GetInfoResponse)) {
...
function deserialize_xchangerpc_GetInfoResponse(buffer_arg) {
  return xchange_pb.GetInfoResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var XchangeService = exports.XchangeService = {
  getInfo: {
    ...
    requestType: xchange_pb.GetInfoRequest,
    responseType: xchange_pb.GetInfoResponse,
