...
function serialize_xchangerpc_ClaimSwapRequest(arg) {
  if (!(arg instanceof xchangerpc_pb.ClaimSwapRequest)) {
    throw new Error('Expected argument of type xchangerpc.ClaimSwapRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_xchangerpc_ClaimSwapRequest(buffer_arg) {
  return xchangerpc_pb.ClaimSwapRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_xchangerpc_ClaimSwapResponse(arg) {
  if (!(arg instanceof xchangerpc_pb.ClaimSwapResponse)) {
    throw new Error('Expected argument of type xchangerpc.ClaimSwapResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_xchangerpc_ClaimSwapResponse(buffer_arg) {
  return xchangerpc_pb.ClaimSwapResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_xchangerpc_CreateReverseSwapRequest(arg) {
  if (!(arg instanceof xchangerpc_pb.CreateReverseSwapRequest)) {
    throw new Error('Expected argument of type xchangerpc.CreateReverseSwapRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_xchangerpc_CreateReverseSwapRequest(buffer_arg) {
  return xchangerpc_pb.CreateReverseSwapRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_xchangerpc_CreateReverseSwapResponse(arg) {
  if (!(arg instanceof xchangerpc_pb.CreateReverseSwapResponse)) {
    throw new Error('Expected argument of type xchangerpc.CreateReverseSwapResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_xchangerpc_CreateReverseSwapResponse(buffer_arg) {
  return xchangerpc_pb.CreateReverseSwapResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var XchangeService = exports.XchangeService = {
  ...
  createReverseSwap: {
    path: '/xchangerpc.Xchange/CreateReverseSwap',
    requestStream: false,
    responseStream: false,
    requestType: xchangerpc_pb.CreateReverseSwapRequest,
    responseType: xchangerpc_pb.CreateReverseSwapResponse,
    requestSerialize: serialize_xchangerpc_CreateReverseSwapRequest,
    requestDeserialize: deserialize_xchangerpc_CreateReverseSwapRequest,
    responseSerialize: serialize_xchangerpc_CreateReverseSwapResponse,
    responseDeserialize: deserialize_xchangerpc_CreateReverseSwapResponse,
  },
  // TODO: remove this temporary method
  //
  // Claims the onchain part of a reverse Swap 
  claimSwap: {
    path: '/xchangerpc.Xchange/ClaimSwap',
    requestStream: false,
    responseStream: false,
    requestType: xchangerpc_pb.ClaimSwapRequest,
    responseType: xchangerpc_pb.ClaimSwapResponse,
    requestSerialize: serialize_xchangerpc_ClaimSwapRequest,
    requestDeserialize: deserialize_xchangerpc_ClaimSwapRequest,
    responseSerialize: serialize_xchangerpc_ClaimSwapResponse,
    responseDeserialize: deserialize_xchangerpc_ClaimSwapResponse,
  },
};
