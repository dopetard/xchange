...
export class RaidenAddressRequest extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RaidenAddressRequest.AsObject;
  static toObject(includeInstance: boolean, msg: RaidenAddressRequest): RaidenAddressRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RaidenAddressRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RaidenAddressRequest;
  static deserializeBinaryFromReader(message: RaidenAddressRequest, reader: jspb.BinaryReader): RaidenAddressRequest;
}

export namespace RaidenAddressRequest {
  export type AsObject = {
  }
}

export class RaidenAddressResponse extends jspb.Message {
  getAddress(): string;
  setAddress(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): RaidenAddressResponse.AsObject;
  static toObject(includeInstance: boolean, msg: RaidenAddressResponse): RaidenAddressResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: RaidenAddressResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): RaidenAddressResponse;
  static deserializeBinaryFromReader(message: RaidenAddressResponse, reader: jspb.BinaryReader): RaidenAddressResponse;
}

export namespace RaidenAddressResponse {
  export type AsObject = {
    address: string,
  }
}
...
export class SendTokenRequest extends jspb.Message {
  ...
  hasPayload(): boolean;
  clearPayload(): void;
  getPayload(): TransferPayload | undefined;
  setPayload(value?: TransferPayload): void;
...
export namespace SendTokenRequest {
  export type AsObject = {
    ...
    payload?: TransferPayload.AsObject,
  }
}

export class SendTokenReponse extends jspb.Message {
  getError(): string;
  setError(value: string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SendTokenReponse.AsObject;
  static toObject(includeInstance: boolean, msg: SendTokenReponse): SendTokenReponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SendTokenReponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SendTokenReponse;
  static deserializeBinaryFromReader(message: SendTokenReponse, reader: jspb.BinaryReader): SendTokenReponse;
}

export namespace SendTokenReponse {
  export type AsObject = {
    error: string,
  }
}
...
export class SubscribeChannelEventsRequest extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): SubscribeChannelEventsRequest.AsObject;
  static toObject(includeInstance: boolean, msg: SubscribeChannelEventsRequest): SubscribeChannelEventsRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SubscribeChannelEventsRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SubscribeChannelEventsRequest;
  static deserializeBinaryFromReader(message: SubscribeChannelEventsRequest, reader: jspb.BinaryReader): SubscribeChannelEventsRequest;
}

export namespace SubscribeChannelEventsRequest {
  export type AsObject = {
  }
}

export class SubscribeChannelEventsResponse extends jspb.Message {
  ...
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: SubscribeChannelEventsResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): SubscribeChannelEventsResponse;
  static deserializeBinaryFromReader(message: SubscribeChannelEventsResponse, reader: jspb.BinaryReader): SubscribeChannelEventsResponse;
}

export namespace SubscribeChannelEventsResponse {
  export type AsObject = {
    blockNumber: number,
    eventType: string,
    identifier: number,
...
export class TransferPayload extends jspb.Message {
  getAmount(): number;
  setAmount(value: number): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): TransferPayload.AsObject;
  static toObject(includeInstance: boolean, msg: TransferPayload): TransferPayload.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: TransferPayload, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): TransferPayload;
  static deserializeBinaryFromReader(message: TransferPayload, reader: jspb.BinaryReader): TransferPayload;
}
